...
define('SITE_URL', 'https://wordpress.dvl.to');
            ...
            0 => [
                ...
                'fields' => [
                    0 => [
                        'fieldname' => 'string_search',
                        'name' => 'Suche',
                        'params' => TS_SEARCH_AUTOCOMPLETE // neu
                    ],
                    1 => [
                        'fieldname' => 'date_picker',
                        'name' => 'Zeitraum',
...
define('TS_FILTERS', [
    0 => [
        'fieldname' => 'sterne_default',
        'name' => 'Sterne',
        'behavior' => 'OR',
    ],
    1 => [
        'fieldname' => 'highlights_default',
        'name' => 'Highlights',
        'behavior' => 'OR',
    ],
    2 => [
        'fieldname' => 'gtxf_destination_default',
        'name' => 'Zielgebiet',
        'behavior' => 'OR',
    ],
    3 => [
        'fieldname' => 'gtxf_reiseart_default',
        'name' => 'Reiseart',
        'behavior' => 'OR',
    ],
    4 => [
        'fieldname' => 'optionen_default',
        'name' => 'Optionen',
        'behavior' => 'OR',
    ],
    5 => [
    ...
    9 => [
        'fieldname' => 'stoerer_default',
        'name' => 'Störer',
        'behavior' => 'OR',
    ],
    10 => [
        'fieldname' => 'veranstalterzuordnung_default',
        'name' => 'Veranstalterzuordnung',
        'behavior' => 'OR',
    ],
    11 => [
        'fieldname' => 'vertriebsportale_default',
        'name' => 'Vertriebsportale',
        'behavior' => 'OR',
    ],
    12 => [
        'fieldname' => 'website_ausgabe_default',
        'name' => 'Website Ausgabe',
        'behavior' => 'OR',
    ],
    13 => [
        'fieldname' => 'travelfeed_default',
        'name' => 'Travelfeed',
        'behavior' => 'OR',
    ],
]);
 ...
 */
//define('TS_SEARCH_GROUP_KEYS', ['1000246']);
