            ...
            <nav aria-label="">
                <ul class="ajax-enabled-pagination pagination">
                    ...
                    <li class="page-item<?php echo ($args['current_page'] == 1) ? ' disabled' : ''; ?>">
                        <a class="page-link"
                           href="?action=search&<?php echo BuildSearch::getCurrentQueryString($args['current_page'] - 1, $args['page_size']); ?><?php echo isset($args['pt']) ? '#pt' . $args['pt'] : '';?>">
                    ...
                    for ($page = $from; $page <= $to; $page++) {
                        ...
                        <li class="page-item<?php echo ($args['current_page'] == $page) ? ' active' : ''; ?>"><a
                                    class="page-link"
                                    href="?action=search&<?php echo BuildSearch::getCurrentQueryString($page, $args['page_size']); ?><?php echo isset($args['pt']) ? '#pt' . $args['pt'] : '';?>"><?php echo $page; ?></a>
                        </li>
                    <?php } ?>
                    <li class="page-item<?php echo ($args['current_page'] == $args['pages']) ? ' disabled' : ''; ?>"><a
                                class="page-link"
                                href="<?php echo ($args['current_page'] >= $args['pages']) ? '#' : '?action=search&' . BuildSearch::getCurrentQueryString($args['current_page'] + 1, $args['page_size']); ?><?php echo isset($args['pt']) ? '#pt' .  $args['pt'] : '';?>">
