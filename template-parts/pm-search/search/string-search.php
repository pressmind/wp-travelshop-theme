...
<input class="auto-complete" type="search" data-autocomplete="true" placeholder="<?php echo empty($args['name']) ? 'Suchbegriff' : $args['name'];?>" aria-label="Search" name="pm-t" value="<?php echo !empty($_GET['pm-t']) ? $_GET['pm-t'] : '';?>">
