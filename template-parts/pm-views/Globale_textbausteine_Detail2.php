...
/**
 * @var Custom\MediaType\Globale_textbausteine $moc
 */
...
<script>
    var ID_MEDIA_OBJECT = <?php echo $args['id_media_object']; ?>;
    var CHEAPEST_PRICE = JSON.parse('<?php echo json_encode($args['cheapest_price']); ?>');
</script>
