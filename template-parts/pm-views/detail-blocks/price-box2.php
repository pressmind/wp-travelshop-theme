                            ...
                            <div class="dropdown-menu-body">
                                <div class="personen-select">
                                    ...
                                    <div class="personen-select-counter">
                                        ...
                                        <input type="text" class="personen-select-counter-input" value="2" data-singular="Person" data-plural="Personen" data-min="1" data-max="5" data-target-input="dropdownPersons"/>
                                        <button type="button" class="personen-select-counter-btn" data-type="+">
