...
<form class="filter-form">
    <a class="filter-switch" data-modal="true" data-modal-id="bofilters">
        <span>Filter:</span>
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-adjustments-horizontal" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#444444" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
$args_modal = [];
$args_modal['title'] = 'Filter wählen';
$args_modal['id_modal'] = 'bofilters';
$args['hide_options'] = false;
$args_modal['content'] = '<div id="booking-filter-mobile"></div>';
