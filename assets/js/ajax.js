            ...
            if ($('[data-type="daterange"]').length > 0) {
                ...
                let picker = $('[data-type="daterange"]').daterangepicker({
                    "ranges": {
                        ...
                        'über Rosenmontag': [rosenmontagDate.clone().subtract(7, 'days'), rosenmontagDate],
                        'über Ostern': [easterDate.clone().subtract(7, 'days'), easterDate],
                        'über Pfingsten': [pfingstenDate.clone().subtract(7, 'days'), pfingstenDate],
